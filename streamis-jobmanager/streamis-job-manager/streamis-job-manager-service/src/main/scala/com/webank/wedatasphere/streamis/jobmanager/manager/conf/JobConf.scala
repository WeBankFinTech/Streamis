...
object JobConf {
  ...
  val NOT_COMPLETED_STATUS_ARRAY = Array(JOBMANAGER_FLINK_JOB_STATUS_ONE,JOBMANAGER_FLINK_JOB_STATUS_TWO, JOBMANAGER_FLINK_JOB_STATUS_THREE, JOBMANAGER_FLINK_JOB_STATUS_FOUR,
