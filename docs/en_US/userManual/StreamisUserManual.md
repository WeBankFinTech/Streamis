...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This article is a quick start document for Streamis 0.2.5, which covers the basic usage process of Stremis. More details on operation and usage will be provided in the user documentation.
