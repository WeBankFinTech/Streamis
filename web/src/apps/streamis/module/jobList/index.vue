      ...
      <div>
        <div>
          <Form ref="queryForm" inline>
            ...
            <FormItem>
              <Button type="primary" @click="handleQuery()" style="margin-left:80px">
          ...
          <Page :total="pageData.total" class="page" :page-size="pageData.pageSize" show-total show-elevator show-sizer/>
        </div>
      </div>
    </titleCard>
  </div>
...
export default {
  ...
  methods: {
    getJobList() {
      this.tableDatas = new Array(10).fill(
        {
    ...
    handleConfig(data) {console.log(data)},
    handleRouter(rowData, moudleName) {
      console.log(rowData);
